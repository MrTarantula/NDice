...
namespace NDice
{
    public class WeightedDie : Die
    {
        ...
        public WeightedDie(int size = 6) : this(new Random(), size) { }
        ...
        /// <param name="size">Size of the die.</param>
        public WeightedDie(Random rnd, int size = 6) : base(rnd, size)
        {
        ...
        public WeightedDie(params int[] weights) : this(new Random(), weights) { }
        ...
        public WeightedDie(Random rnd, params int[] weights) : base(rnd, weights.Length) => Weight = weights;
